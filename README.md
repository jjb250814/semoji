...
| 구글 | 서치콘솔 도메인 속성 + 사이트맵 등록. **색인 요청 5건 밀림 (아래)** |
| 네이버 | 서치어드바이저 등록 + 사이트맵 등록. **수집 요청 5건 밀림 (아래)** |
...
웹 페이지 수집에 아래 주소를 넣는다. 급하지 않으니 제18호와 한 번에 넣어도 된다
(9단계 「배포와 재제출」 참고).

- https://semoji.net/door-to-door/
- https://semoji.net/tree/
- https://semoji.net/dental-lab/
